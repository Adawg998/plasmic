...
import Label from "../../Label"; // plasmic-import: adke6RBh20Cw/component
import TextInput from "../../TextInput"; // plasmic-import: gyFrEBMhlxcZ/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: bKeBsF_T-4Ls/component
import Description from "../../Description"; // plasmic-import: yMcm8n3P4Tzz/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: qbdePUKEIrAD/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames("all", sty.freeBox__cuGu, {
          [sty.freeBoxiconEnd__cuGuGq1A5]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__cuGu7Qj3S]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__cuGuFuGhS]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames("all", sty.freeBox__oCfQr, {
            [sty.freeBoxiconStart__oCfQr7Qj3S]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__oCfQrfuGhS]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames("all", sty.svg__zsdSe)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames("all", sty.freeBox__wsim, {
            [sty.freeBoxiconEnd__wsimGq1A5]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__wsim7Qj3S]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames("all", sty.svg___1E6Ig)}
                role={"img"}
              />
            ),
