...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: Vss7SSBnCn9G/css
...
function PlasmicTestimonial__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames("all", sty.freeBox__u13ZU)}>
        {renderPlasmicSlot({
          defaultContents:
      ...
      <div className={classNames("all", sty.freeBox__awxjn)}>
        <PlasmicImg__
        ...
        <div className={classNames("all", sty.freeBox__uyahs)}>
          <div className={classNames("all", sty.freeBox__tmWm3)}>
            {renderPlasmicSlot({
