...
import sty from "./PlasmicNavbar.module.css"; // plasmic-import: 0cn6bKm8EegY/css
...
function PlasmicNavbar__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames("all", sty.freeBox__noF9X)}>
        <Logo
        ...
        <div className={classNames("all", sty.freeBox___5CK)}>
          <PlasmicLink__
            className={classNames(
              "all",
              "a",
