...
import sty from "./PlasmicValueProp.module.css"; // plasmic-import: QReoVcGTgpc7/css
    ...
    () => [
      {
        ...
        initFunc: ({ $props, $state, $queries, $q, $ctx }) => $props.flatIcon
      },
      {
        path: "vertical",
        type: "private",
        variableType: "variant",
        initFunc: ({ $props, $state, $queries, $q, $ctx }) => $props.vertical
      },
      {
        path: "card",
        type: "private",
        variableType: "variant",
        initFunc: ({ $props, $state, $queries, $q, $ctx }) => $props.card
      },
      {
        path: "noTitle",
        type: "private",
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img__dF2EW)}
              displayHeight={"56px"}
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicValueProp__VariantsArgs, ReservedPropsType> &
